//Creating a project for Online Examination using java Programming Language By PRAJWAL...
...
public class OnlineExamination1 {
    ...
    void login() {
        ...
        if (username.equals("PRAJWAL") && password ==9831) {
    ...
    public static void main(String[] args) {
		...
		OnlineExamination1 e1 =new OnlineExamination1();
		e1.login();
